...
namespace ToolBox.Dashboard
{
    public class DashboardModule : IModule
    {
        ...
        public void Initialize()
        {
            ...
            this.regionManager.RegisterViewWithRegion(RegionNames.AppBarRegion, () => this.container.Resolve<DashboardAppBarView>());
            this.regionManager.RegisterViewWithRegion(RegionNames.MenuRegion, () => this.container.Resolve<DashboardMenuView>());
            this.regionManager.RegisterViewWithRegion(RegionNames.SubMenuRegion, () => this.container.Resolve<DashboardSubMenuView>());
