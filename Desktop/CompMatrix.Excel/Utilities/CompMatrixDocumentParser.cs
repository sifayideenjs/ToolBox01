...
namespace ToolBox.Excel.Utilities
{
    public class CompMatrixDocumentParser
    {
        ...
        public List<CompMatrixModel> Parse(string filePath)
        {
            List<CompMatrixModel> compMatrixList = Parse(filePath, null);
            return compMatrixList;
        }

        public List<CompMatrixModel> Parse(string filePath, params string[] args)
        {
            ...
            try
            {
                ...
                SpreadsheetDocument excdocument = SpreadsheetDocument.Open(filePath, false);
